...
export default function GithubRepoCard({
  ...
  return (
    <div className="flex h-full flex-col rounded border p-4 hover:scale-[1.1] hover:bg-gray-100">
      <a
        href={html_url}
        target="_blank"
        rel="noreferrer"
        className="flex h-full cursor-pointer flex-col font-medium "
      >
        ...
        <div className="mb-4 mt-2 text-gray-900">{description}</div>
